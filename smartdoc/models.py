...
class Product(AbstractModel):
    ...
    code = models.TextField(max_length=30, blank=True, default='', verbose_name='产品编码',)
...
class Document(AbstractModel):
    ...
    doc_file = models.FileField(upload_to=user_directory_path, blank=True, null=True, verbose_name='文件上传')
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='documents', verbose_name='产品')
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='documents', verbose_name='分类')
